...
public class WarehouseLocations extends AppCompatActivity {
    ...
    public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewHolder> {
        ...
        public RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new RecyclerViewHolder(LayoutInflater.from(WarehouseLocations.this).inflate(R.layout.warehouse_location_list_items, parent, false));
        }
        ...
        public RecyclerViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(WarehouseLocations.this, Scanning.class);
                    args.putString("code", warehouses.get(getAdapterPosition()).getCode());
                    args.putString("warehouseName", warehouses.get(getAdapterPosition()).getName());
    ...
    public class GetWarehouseLocations extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if(warehouses.size() > 0){
                ...
                recyclerView.setLayoutManager(new LinearLayoutManager(WarehouseLocations.this));
            }
            else{
