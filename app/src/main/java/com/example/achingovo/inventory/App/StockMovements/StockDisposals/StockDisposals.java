package com.example.achingovo.inventory.App.StockMovements.StockDisposals;
...
/*        setSupportActionBar(toolbar);
    ...
    public class StockDisposal extends AsyncTask<String, Void, Void> {
        ...
        List<com.example.achingovo.inventory.Repository.B1_Objects.SerialNumbers> SerialNumbers = new ArrayList<>();
